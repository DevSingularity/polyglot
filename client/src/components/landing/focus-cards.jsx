...
export const Card = React.memo(
  ({ card, index, hovered, setHovered }) => (
    <div
      ...
      className={cn(
        "rounded-2xl relative shadow-neu-inset bg-background/50 border border-border/20 overflow-hidden h-40 md:h-[350px] w-full transition-all duration-300 ease-out flex",
