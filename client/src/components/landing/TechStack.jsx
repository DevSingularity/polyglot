        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TECH.map((item, i) => (
            <motion.div 
              ...
              className="p-8 rounded-3xl shadow-neu-inset bg-background/50 border border-border/20 hover:border-gold/20 transition-all flex flex-col items-center text-center group"
            >
              <div 
                className="w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(0,0,0,0.3)] group-hover:shadow-gold/10 transition-shadow"
              ...
              <p className="text-gold font-mono text-[10px] font-bold tracking-widest uppercase mb-4">{item.role}</p>
