...
export default function HowItWorks() {
  return (
    <section className="relative py-24 sm:py-32 bg-card border-t border-border/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        
        {/* Header */}
        <div className="text-center mb-20">
          <h2 className="text-gold font-mono text-sm font-bold tracking-[0.2em] uppercase mb-4">
            The Workflow
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-[44px] left-[10%] right-[10%] h-[1px] bg-gradient-to-r from-transparent via-border/50 to-transparent z-0" />
          ...
          {STEPS.map((step, i) => (
            ...
            >
              ...
              >
                 ...
                 {/* Step Number */}
                 <div className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-background border border-border/20 text-[10px] font-bold flex items-center justify-center text-slate-500 shadow-neu-inset">
                   0{i + 1}
                 </div>
              </div>

              <h4 className="text-white font-display font-bold text-lg mb-3 tracking-tight group-hover:text-gold transition-colors">
                {step.title}
              </h4>
