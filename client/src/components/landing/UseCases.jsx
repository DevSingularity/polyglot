        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {CASES.map((item, i) => (
            <motion.div 
              ...
              className="group relative p-8 rounded-3xl shadow-neu-inset bg-background/50 border border-border/20 hover:border-gold/30 transition-all duration-300 overflow-hidden"
            >
              {/* Corner accent */}
              <div 
              ...
              <div className="flex flex-col h-full relative z-10">
                ...
                <h4 className="text-2xl font-display font-bold text-white mb-4 group-hover:text-gold transition-colors">
                  {item.title}
                </h4>
