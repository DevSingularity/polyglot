...
export default function SolutionSection() {
  return (
    <section className="relative py-24 sm:py-32 bg-card border-t border-border/20 overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-[20%] right-0 w-[600px] h-[600px] bg-gold/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-16 items-center">
          ...
          <div className="flex flex-col">
            <h2 className="text-gold font-mono text-sm font-bold tracking-widest uppercase mb-4">
              Our Solution
            </h2>
            <h3 className="text-4xl sm:text-5xl font-display font-extrabold text-white leading-tight mb-8">
              AI‑Powered <br /> 
              <span className="text-gradient-gold">Dependency Intelligence</span>
            </h3>
            ...
            <ul className="grid gap-5">
              {[
                ...
                >
                  <div className="mt-1 w-6 h-6 rounded-full bg-gold/10 flex items-center justify-center flex-shrink-0">
            ...
            <div className="mt-12 flex items-center gap-2 text-gold font-bold text-sm tracking-wide">
          ...
          <div className="relative h-[450px] sm:h-[550px] bg-card rounded-3xl border border-border/20 p-8 flex items-center justify-center isolate overflow-hidden shadow-neu-inset">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
               ...
               <motion.div 
                 animate={{ scale: [1, 1.05, 1], boxShadow: ['0 0 40px rgba(212,175,55,0.2)', '0 0 80px rgba(212,175,55,0.4)', '0 0 40px rgba(212,175,55,0.2)'] }}
                 transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
                 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-28 h-28 rounded-3xl bg-card border border-gold/20 flex items-center justify-center z-30"
               >
                 <Search size={40} className="text-gold" strokeWidth={2.5} />
               </motion.div>
               ...
               <svg className="absolute inset-0 w-full h-full pointer-events-none z-20" overflow="visible">
                 ...
                 <ConnectedLine x1="50%" y1="50%" x2="20%" y2="25%" color="#D4AF37" delay={0} />
                 <ConnectedLine x1="50%" y1="50%" x2="80%" y2="25%" color="#D4AF37" delay={0.2} />
                 <ConnectedLine x1="50%" y1="50%" x2="20%" y2="75%" color="#D4AF37" delay={0.4} />
                 <ConnectedLine x1="50%" y1="50%" x2="80%" y2="75%" color="#D4AF37" delay={0.6} />
               </svg>
...
function PeripheralNode({ x, y, label, color, icon: Icon }) {
  const themes = {
    cyan: { bg: 'var(--bg-card)', border: '#D4AF37', text: '#D4AF37' },
    blue: { bg: 'var(--bg-card)', border: '#D4AF37', text: '#D4AF37' },
    indigo: { bg: 'var(--bg-card)', border: '#D4AF37', text: '#D4AF37' },
    emerald: { bg: 'var(--bg-card)', border: '#D4AF37', text: '#D4AF37' }
  };
