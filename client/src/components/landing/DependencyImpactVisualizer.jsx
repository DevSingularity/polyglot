  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center select-none">
      ...
      <div
        ...
        style={{
          background: showError
            ...
            : 'radial-gradient(ellipse 60% 40% at 60% 50%, rgba(212,175,55,0.07) 0%, transparent 80%)',
      ...
      <div className="w-full flex flex-col gap-6 relative z-10">
        {/* ── PARENT / MAIN FILE ── */}
        <WindowChrome filename="api-service/config.ts" lang="TS" langColor="#D4AF37" isError={false}>
          <div className="font-mono text-sm leading-6 sm:text-base">
            ...
            <div className="text-slate-400 mb-2">
              <span className="text-gold">export const</span>{' '}
