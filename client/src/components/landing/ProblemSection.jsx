...
export default function ProblemSection() {
  return (
    <section className="relative py-24 sm:py-32 bg-card overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-gold/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid gap-6">
              {PAIN_POINTS.map((point) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  className="flex gap-4 p-5 rounded-2xl shadow-neu-inset bg-background/50 border border-border/20 hover:border-gold/30 transition-colors group"
                >
                  <div 
          ...
          <div className="relative w-full h-[400px] sm:h-[500px] mt-8 lg:mt-0 flex items-center justify-center">
            ...
            <motion.div 
              ...
              className="absolute w-[350px] h-[350px] bg-gold/20 rounded-full blur-[100px]"
            />
            ...
            <div className="relative w-full max-w-[500px] h-full">
              ...
              {/* Node: React Frontend */}
              <motion.div 
                className="absolute top-[85px] left-[30px] w-[220px] p-5 rounded-2xl glass-premium shadow-neu-inset z-10"
              ...
              {/* Node: Python Service */}
              <motion.div 
                className="absolute top-[345px] left-[260px] w-[220px] p-5 rounded-2xl glass-premium shadow-neu-inset z-10"
                whileHover={{ y: -5, borderColor: 'rgba(212, 175, 55, 0.3)' }}
              >
              ...
              <div className="absolute top-[265px] left-[255px] -translate-x-1/2 -translate-y-1/2 z-20">
                ...
                >
                  {/* Heavy Glow behind the badge */}
                  <div className="absolute inset-[-15px] bg-gold/30 rounded-full blur-[25px] -z-10" />
                  
                  <div className="relative px-6 py-2.5 rounded-full bg-card border border-gold/60 text-gold text-[12px] sm:text-[13px] font-mono font-bold tracking-[0.2em] shadow-[0_0_35px_rgba(212,175,55,0.5)] whitespace-nowrap overflow-hidden">
                    VISIBILITY GAP
                  </div>
                </motion.div>
